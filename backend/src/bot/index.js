...
//                 "/start - Start the bot\n" +
//                 "/link - Link your Online-study.com account\n" +
...
//             await ctx.reply(
//                 "To link your Online-study.com account, I'll need your email address.\n\n" +
//                 "Please enter the email you used to register on Online-study.com:"
//             );
//         } catch (error) {
...
//                         await ctx.reply("❌ Email not found. Please make sure your email is registered with Online-study.com.");
...
//                 await ctx.reply(
//                     "You need to link your Online-study.com account first. Use /link to get started."
//                 );
//                 return;
//             }
...
//             if (!user) {
//                 await ctx.reply(
//                     "Your account is not linked. Use /link to connect your Online-study.com account."
//                 );
//                 return;
//             }
...
//             await ctx.reply(
//                 "⚠️ Are you sure you want to unlink your Online-study.com account? You will no longer receive notifications.\n\n" +
...
//                 if (!user) {
//                     await ctx.reply("Your account is not linked to Online-study.com.");
//                     ctx.session.step = 'idle';
//                     return;
//                 }
...
//                 await ctx.reply(
//                     "✅ Your Online-study.com account has been unlinked successfully.\n\n" +
...
//             }
//         } else if (answer === 'no' || answer === 'n') {
//             await ctx.reply("Account unlinking canceled. Your account remains linked to Online-study.com.");
//         } else {
//             await ctx.reply("Please answer with Yes or No.");
